...
# Herramientas para Nuke y Hiero — Scripts del libro
...
Compartido por las ediciones ES/EN/FR del libro: código único, documentación en los tres idiomas.

## Licencia

MIT para el código; el texto del libro, todos los derechos reservados.
